...
import keyboard
import numpy as np
from dlib_landmarks import draw_point, eye_center_dlib, landmarks_array, fill_frame, crop_eyes, eye_corner_dlib
...
# ---------------------------------- Show vector after pressing v --------------------------------------------------- #
        ...
        if press_v:
            # finding eye center
            left_center_eye, c = eye_center_dlib(left_eye_crop, [min_left[0], min_left[1]])
            right_center_eye, d = eye_center_dlib(right_eye_crop, [min_right[0], min_right[1]])

            a, left_corner_eye_in_eye_frame = eye_corner_dlib(left_eye_crop, [min_left[0], min_left[1]])
            b, right_corner_eye_in_eye_frame = eye_corner_dlib(right_eye_crop, [min_right[0], min_right[1]])

            # finding vector
            output_vector_in_eye_frame = find_vector(left_center_pupil_in_eye_frame, left_corner_eye_in_eye_frame,
                                                     right_center_pupil_in_eye_frame, right_corner_eye_in_eye_frame)
