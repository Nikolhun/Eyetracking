...
def change_coordinates_of_target(coordinates_of_center_dot, size_of_output_screen, part, change_accepted,
    ...
    if left_right <= int((80*size_of_output_screen[0])/100) and part == 1 and change_accepted == True:
    ...
    if top_bottom <= int((80 * size_of_output_screen[1]) / 100) and part == 2 and change_accepted == True:
    ...
    if left_right >= int((30 * size_of_output_screen[0]) / 100) and part == 3 and change_accepted == True:
        left_right = left_right - 1
        change_accepted = False
        part_out = 3
    ...
    if top_bottom >= int((55 * size_of_output_screen[1]) / 100) and part == 4 and change_accepted == True:
        top_bottom = top_bottom - 1
        change_accepted = False
        part_out = 4
    ...
    if left_right <= int((65 * size_of_output_screen[0]) / 100) and part == 5 and change_accepted == True:
        left_right = left_right + 1
        change_accepted = False
        part_out = 5
    ...
    if top_bottom >= int((40 * size_of_output_screen[1]) / 100) and part == 6 and change_accepted == True:
        top_bottom = top_bottom - 1
        change_accepted = False
        part_out = 6
    ...
    if left_right >= int((20 * size_of_output_screen[0]) / 100) and part == 7 and change_accepted == True:
        left_right = left_right - 1
        change_accepted = False
        part_out = 7
    ...
    if top_bottom >= int((20 * size_of_output_screen[1]) / 100) and part == 8 and change_accepted == True:
        top_bottom = top_bottom - 1
        change_accepted = False
        part_out = 8
    ...
    if left_right >= 0 and part == 9 and change_accepted == True:
        left_right = left_right - 1
        change_accepted = False
        part_out = 9
    ...
    if top_bottom >= 0 and part == 10 and change_accepted == True:
        top_bottom = top_bottom - 1
        change_accepted = False
        part_out = 10
    ...
    if left_right <= size_of_output_screen[0]-1 and part == 11 and change_accepted == True:
        left_right = left_right + 1
        change_accepted = False
        part_out = 11
    ...
    if top_bottom <= size_of_output_screen[1]-1 and part == 12 and change_accepted == True:
        top_bottom = top_bottom + 1
        change_accepted = False
        part_out = 12
    ...
    if left_right >= 0 and part == 13 and change_accepted == True:
        left_right = left_right - 1
        change_accepted = False
        part_out = 13
    ...
    if top_bottom >= int(size_of_output_screen[1]/2) and part == 14 and change_accepted == True:
        top_bottom = top_bottom - 1
        change_accepted = False
        part_out = 14
    ...
    if left_right <= int(size_of_output_screen[0]/2) and part == 15 and change_accepted == True:
        left_right = left_right + 1
        change_accepted = False
        part_out = 15
